...
function initRegressiveTimer() {
    ...
    const interval = setInterval( () => {
        ...
        //console.log( `${time.days}days ${time.hours}h ${time.minutes}m ${time.seconds}s `, leftCountdown.timestamp);
    }, 1000);
}
...
`{
    ...
    const interval = setInterval( () => {
        ...
        else if(elapsedCountdown.actualDate.getTime() < elapsedCountdown.targetDate.getTime()){//data inicial ainda não chegou
            clearInterval(interval);
        ...
        if(elapsed != null) {
            ...
            extended: {days: ${elapsedDays.days}, hours: ${elapsedDays.hours}, minutes: ${elapsedDays.minutes}, seconds: ${elapsedDays.seconds}}\n}\n\n`;
        }
        ...
        if(left != null) {
            ...
            extended: {days: ${leftDays.days}, hours: ${leftDays.hours}, minutes: ${leftDays.minutes}, seconds: ${leftDays.seconds}}\n}`;
        }
